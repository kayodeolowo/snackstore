                       ...
                       <div className='relative'> 
                            ...
                            src= {user ? user.photoURL : Avatar} 
...

                             {
                                ...
                                <p className='px- py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base'> logout <HiOutlineLogout/> </p>
